...
#                 caretakerId = db.add_caretaker_empty()
...
#                 donation = db.select_id("donations",group[0])
#                 donor = db.select_id("donor",group[0])
#                 donorPerson = db.select_ref_id("person","donor",donor[0])
#                 caretaker = db.select_id("caretaker",group[2])
